...
class DataSet(DataObject, BaseDataSet[Item]):
    ...
    @setdoc.basic
    def __iand__(self: Self, other: BaseDataSet[Hashable], /) -> Self:
    ...
    @setdoc.basic
    def __ixor__(self: Self, other: BaseDataSet[Item], /) -> Self:
        self.data ^= other.data
        return self
...
MutableSet.register(DataSet)  # type: ignore[type-abstract]
