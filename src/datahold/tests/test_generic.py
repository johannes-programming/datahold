...
class TestDataholdGenerics(unittest.TestCase):
    def _assert_is_generic(self, cls, n_type_params: int) -> None:
        """
    ...
    def test_DataDict_is_generic_and_mapping(self):
    ...
    def test_DataList_is_generic_and_sequence(self):
    ...
    def test_DataSet_is_generic_and_set(self):
    ...
    def test_ABC_types_are_generic_if_subscriptable(self):
        """
