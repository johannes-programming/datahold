...
class BaseDataSet(BaseDataObject, Generic[Item]):
    ...
    @setdoc.setdoc(set.__rand__.__doc__)  # type: ignore[attr-defined]
    def __rand__(
        self: Self,
        value: Any,
        /,
    ) -> Any:
        return set(self.data).__rand__(value)  # type: ignore[attr-defined]
    ...
    def __ror__(
        ...
        return set(self.data).__ror__(value)  # type: ignore[attr-defined]

    @setdoc.setdoc(set.__rsub__.__doc__)  # type: ignore[attr-defined]
    def __rsub__(
        self: Self,
        value: Any,
        /,
    ) -> Any:
        return set(self.data).__rsub__(value)  # type: ignore[attr-defined]

    @setdoc.setdoc(set.__rxor__.__doc__)  # type: ignore[attr-defined]
    def __rxor__(self: Self, value: Any, /) -> Any:
        return set(self.data).__rxor__(value)  # type: ignore[attr-defined]
