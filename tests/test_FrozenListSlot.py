__all__: list[str] = [
    ...
    "TestOperatorAllBuiltin",
    "TestOperatorAnyBuiltin",
    "TestOperatorAugmentedAddition",
    "TestOperatorAugmentedMultiplication",
    "TestOperatorBoolBuiltin",
    "TestOperatorEnumerateBuiltin",
    "TestOperatorEquality",
    "TestOperatorHashBuiltin",
    "TestOperatorInequality",
    "TestOperatorIterBuiltin",
    "TestOperatorLenBuiltin",
    "TestOperatorLessThan",
    "TestOperatorListBuiltin",
    "TestOperatorMaxBuiltin",
    "TestOperatorMembership",
    "TestOperatorMinBuiltin",
    "TestOperatorMultiplication",
    "TestOperatorNonMembership",
    "TestOperatorReversedBuiltin",
    "TestOperatorSortedBuiltin",
    "TestOperatorSubscription",
    "TestOperatorSumBuiltin",
    "TestOperatorTupleBuiltin",
]
...
class TestOperatorAugmentedAddition(unittest.TestCase):
...
class TestOperatorAugmentedMultiplication(unittest.TestCase):
...
class TestOperatorAllBuiltin(unittest.TestCase):
...
class TestOperatorAnyBuiltin(unittest.TestCase):
...
class TestOperatorBoolBuiltin(unittest.TestCase):
...
class TestOperatorEnumerateBuiltin(unittest.TestCase):
...
class TestOperatorHashBuiltin(unittest.TestCase):
...
class TestOperatorIterBuiltin(unittest.TestCase):
...
class TestOperatorLenBuiltin(unittest.TestCase):
...
class TestOperatorListBuiltin(unittest.TestCase):
...
class TestOperatorMaxBuiltin(unittest.TestCase):
...
class TestOperatorMinBuiltin(unittest.TestCase):
...
class TestOperatorReversedBuiltin(unittest.TestCase):
...
class TestOperatorSortedBuiltin(unittest.TestCase):
...
class TestOperatorSumBuiltin(unittest.TestCase):
...
class TestOperatorTupleBuiltin(unittest.TestCase):
