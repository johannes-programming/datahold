...
class TestUnhashable(unittest.TestCase):
    def test_hash(self: Self) -> None:
        with self.assertRaises(Exception):
            hash(MutableListLikeHold())


class TestAppend(unittest.TestCase):
    def test_append_integer(self: Self) -> None:
        actual: MutableListLikeHold[int]
        actual_result: MutableListLikeHold[int]
        expected: list[int]
    ...
    def test_append_same_object_twice(self: Self) -> None:
        actual: MutableListLikeHold[object]
...
class TestCopy(unittest.TestCase):
    def test_copy_equal_contents(self: Self) -> None:
        actual: MutableListLikeHold[int]
        copied: MutableListLikeHold[int]
        actual = MutableListLikeHold([1, 2, 3])
        copied = actual.copy()
    ...
    def test_copy_empty(self: Self) -> None:
        actual: MutableListLikeHold[Never]
        copied: MutableListLikeHold[Never]
        actual = MutableListLikeHold([])
        copied = actual.copy()
    ...
    def test_copy_is_shallow(self: Self) -> None:
        actual: MutableListLikeHold[list[int]]
        nested: list[int]
        nested = [1]
...
class TestCount(unittest.TestCase):
    ...
    def test_count_none(self: Self) -> None:
        actual: MutableListLikeHold[Optional[int]]
