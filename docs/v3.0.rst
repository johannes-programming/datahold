...
``class datahold.BaseDataDict[Key, Value](data: Any = (), /, **kwargs: Value)``
~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~
...
``__reversed__(self: Self, /) -> Iterable[Key]``
^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^
...
``class datahold.BaseDataList[Item](data: Iterable[Item] = (), /)``
~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~
...
``class datahold.BaseDataObject(data: Any, /)``
~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~
...
``class datahold.BaseDataSet[Item](data: Iterable[Item] = (), /)``
~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~
...
``class datahold.BaseHoldDict[Key, Value](data: Any = (), /, **kwargs: Value)``
~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~
...
``class datahold.BaseHoldList[Item](data: Iterable[Item] = (), /)``
~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~
...
``class datahold.BaseHoldObject(data: Any, /)``
~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~
...
``class datahold.BaseHoldSet[Item](data: Iterable[Item] = (), /)``
~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~
...
``class datahold.FrozenDataDict[Key, Value](data: Any = (), /, **kwargs: Value)``
~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~

``__slots__ = ()``
^^^^^^^^^^^^^^^^^^

``class datahold.FrozenDataList[Item](data: Iterable[Item] = (), /)``
~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~

``__slots__ = ()``
^^^^^^^^^^^^^^^^^^

``class datahold.FrozenDataObject(data: Any, /)``
~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~

``__slots__ = ()``
^^^^^^^^^^^^^^^^^^

``class datahold.FrozenDataSet[Item](data: Iterable[Item] = (), /)``
~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~

``__slots__ = ()``
^^^^^^^^^^^^^^^^^^

``class datahold.FrozenHoldDict[Key, Value](data: Any = (), /, **kwargs: Value)``
~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~
...
``class datahold.FrozenHoldList[Item](data: Iterable[Item] = (), /)``
~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~
...
``class datahold.FrozenHoldObject(data: Any, /)``
~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~
...
``class datahold.FrozenHoldSet[Item](data: Iterable[Item] = (), /)``
~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~
