...
It implements the methods ``__add__``, ``__contains__``, ``__ge__``, ``__getitem__``, ``__gt__``,
``__iter__``, ``__le__``, ``__len__``, ``__lt__``, ``__mul__``,
``__repr__``, ``__reversed__``, ``__rmul__``, ``count``, and ``index`` accordingly.
...
This abstract base ``class`` inherits from ``BaseDataObject``.
It works analogously to ``BaseDataDict``.
It implements the methods ``__and__``, ``__contains__``, ``__ge__``, ``__gt__``,
``__iter__``, ``__le__``, ``__len__``, ``__lt__``,
``__or__``, ``__rand__``, ``__repr__``, ``__ror__``, ``__rsub__``, ``__rxor__``, ``__sub__``, ``__xor__``,
