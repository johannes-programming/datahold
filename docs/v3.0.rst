...
``class datahold.base.BaseDataDict.BaseDataDict[Key, Value](data: Any = (), /, **kwargs: Any)``
~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~
...
``__add__(other: list[Item_], /) -> list[Item | Item_]``
^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^

This abstract method is to be overwritten to implement ``self + other``.

``__contains__(other: object, /) -> bool``
^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^

This abstract method is to be overwritten to implement ``other in self``.

``__getitem__(index: SupportsIndex, /) -> Item``
^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^

This abstract method is to be overwritten to implement ``self[index]``.

``__iter__() -> Iterator[Item]``
^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^

This abstract method is to be overwritten to implement ``iter(self)``.

``__len__() -> int``
^^^^^^^^^^^^^^^^^^^^

This abstract method is to be overwritten to implement ``len(self)``.

``__mul__(other: SupportsIndex, /) -> list[Item]``
^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^
...
This abstract method is to be overwritten to implement ``repr(self)``.

``__reversed__() -> Iterator[Item]``
^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^

This abstract method is to be overwritten to implement ``reversed(self)``.

``__rmul__(value: SupportsIndex, /) -> list[Item]``
^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^

This abstract method is to be overwritten to implement ``other * self``.
...
``index(value: object, start: SupportsIndex = 0, end: SupportsIndex = sys.maxsize, /) -> int``
^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^
...
``class datahold.base.BaseDataSet.BaseDataSet[Item](data: Any = (), /)``
~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~
...
``class datahold.base.BaseHoldDict.BaseHoldDict[Key, Value](data: Any = (), /, **kwargs: Any)``
~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~
...
``class datahold.base.BaseHoldList.BaseHoldList[Item](data: Any = (), /)``
~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~
...
``class datahold.base.BaseHoldSet.BaseHoldSet[Item](data: Any = (), /)``
~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~
...
``class datahold.DataDict[Key, Value](data: Any = (), /, **kwargs: Any)``
~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~
...
``class datahold.DataList[Item](data: Any = (), /)``
~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~
...
``class datahold.DataSet[Item](data: Any = (), /)``
~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~

``__slots__ = ()``
^^^^^^^^^^^^^^^^^^

``class datahold.HoldDict[Key, Value](data: Any = (), /, **kwargs: Any)``
~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~
...
``class datahold.HoldList[Item](data: Any = (), /)``
~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~
...
``class datahold.HoldSet[Item](data: Any = (), /)``
~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~
...
``class datahold.frozen.FrozenDataDict.FrozenDataDict[Key, Value](data: Any = (), /, **kwargs: Any)``
~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~

``__slots__ = ()``
^^^^^^^^^^^^^^^^^^

``class datahold.frozen.FrozenDataList.FrozenDataList[Item](data: Any = (), /)``
~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~
...
``class datahold.frozen.FrozenDataSet.FrozenDataSet[Item](data: Any = (), /)``
~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~

``__slots__ = ()``
^^^^^^^^^^^^^^^^^^

``class datahold.frozen.FrozenHoldDict.FrozenHoldDict[Key, Value](data: Any = (), /, **kwargs: Any)``
~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~
...
``class datahold.frozen.FrozenHoldList.FrozenHoldList[Item](data: Any = (), /)``
~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~
...
``class datahold.frozen.FrozenHoldSet.FrozenHoldSet[Item](data: Any = (), /)``
~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~
